...
Let $ign$ be the ignition node, $p\in P$ be the set of nodes to be protected. Wirte $SPT_p$ as the shortest path from $ign$ to $p$ and $c_p$ be the corresponding travel cost.
It suffices

$$\sum_{i\in SPT_p}\sum_{b_k<C_p}z_i^k\geq 1$$
